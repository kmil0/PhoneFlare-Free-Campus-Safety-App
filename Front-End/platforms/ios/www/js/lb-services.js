...
var urlBase = "http://api.phoneflare.com";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.emergencies.findById() instead.
        "prototype$__findById__emergencies": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/emergencies/:fk",
          method: "GET"
        },

        // INTERNAL. Use User.emergencies.destroyById() instead.
        "prototype$__destroyById__emergencies": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/emergencies/:fk",
        ...
        // INTERNAL. Use User.emergencies.updateById() instead.
        "prototype$__updateById__emergencies": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/users/:id/emergencies/:fk",
        ...
        // INTERNAL. Use User.emergencies() instead.
        "prototype$__get__emergencies": {
          isArray: true,
          url: urlBase + "/users/:id/emergencies",
          method: "GET"
        },

        // INTERNAL. Use User.emergencies.create() instead.
        "prototype$__create__emergencies": {
          url: urlBase + "/users/:id/emergencies",
          method: "POST"
        },

        // INTERNAL. Use User.emergencies.destroyAll() instead.
        "prototype$__delete__emergencies": {
          url: urlBase + "/users/:id/emergencies",
          method: "DELETE"
        },

        // INTERNAL. Use User.emergencies.count() instead.
        "prototype$__count__emergencies": {
          url: urlBase + "/users/:id/emergencies/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.User#alert_emergency
         * @methodOf lbServices.User
         *
         * @description
         *
         ...
         */
        "alert_emergency": {
          url: urlBase + "/users/:id/alert_emergency",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.User#deescalate_emergency
         * @methodOf lbServices.User
         *
         * @description
         *
         ...
         *  - `sms_response` – `{object=}` - 
         */
        "deescalate_emergency": {
          url: urlBase + "/users/:id/deescalate_emergency",
          method: "POST"
        },
        ...
        // INTERNAL. Use Emergency.user() instead.
        "::get::emergency::user": {
          url: urlBase + "/emergencies/:id/user",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.emergencies
     * @header lbServices.User.emergencies
     * @object
     * @description
     *
     * The object `User.emergencies` groups methods
     * manipulating `Emergency` instances related to `User`.
     *
     * Call {@link lbServices.User#emergencies User.emergencies()}
     * to query all related instances.
     */
         ...
         * </em>
         */
        R.emergencies = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::get::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#count
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Counts emergencies of user.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        R.emergencies.count = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::count::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#create
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Creates a new instance in emergencies of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.emergencies.create = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::create::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#createMany
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         ...
         * </em>
         */
        R.emergencies.createMany = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::createMany::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#destroyAll
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Deletes all emergencies of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.emergencies.destroyAll = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::delete::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#destroyById
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Delete a related item by id for emergencies.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for emergencies
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.emergencies.destroyById = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::destroyById::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#findById
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Find a related item by id for emergencies.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.emergencies.findById = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::findById::user::emergencies"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.User.emergencies#updateById
         * @methodOf lbServices.User.emergencies
         *
         * @description
         *
         * Update a related item by id for emergencies.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.emergencies.updateById = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::updateById::user::emergencies"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Alert.emergency() instead.
        "prototype$__get__emergency": {
          url: urlBase + "/alerts/:id/emergency",
          method: "GET"
        },
        ...
        // INTERNAL. Use Emergency.alerts.findById() instead.
        "::findById::emergency::alerts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/emergencies/:id/alerts/:fk",
          method: "GET"
        },

        // INTERNAL. Use Emergency.alerts.destroyById() instead.
        "::destroyById::emergency::alerts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/emergencies/:id/alerts/:fk",
        ...
        // INTERNAL. Use Emergency.alerts.updateById() instead.
        "::updateById::emergency::alerts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/emergencies/:id/alerts/:fk",
        ...
        // INTERNAL. Use Emergency.alerts() instead.
        "::get::emergency::alerts": {
          isArray: true,
          url: urlBase + "/emergencies/:id/alerts",
          method: "GET"
        },

        // INTERNAL. Use Emergency.alerts.create() instead.
        "::create::emergency::alerts": {
          url: urlBase + "/emergencies/:id/alerts",
          method: "POST"
        },

        // INTERNAL. Use Emergency.alerts.createMany() instead.
        "::createMany::emergency::alerts": {
          isArray: true,
          url: urlBase + "/emergencies/:id/alerts",
          method: "POST"
        },

        // INTERNAL. Use Emergency.alerts.destroyAll() instead.
        "::delete::emergency::alerts": {
          url: urlBase + "/emergencies/:id/alerts",
          method: "DELETE"
        },

        // INTERNAL. Use Emergency.alerts.count() instead.
        "::count::emergency::alerts": {
          url: urlBase + "/emergencies/:id/alerts/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Alert";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Alert#emergency
         * @methodOf lbServices.Alert
         *
         * @description
         *
         * Fetches belongsTo relation emergency.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.emergency = function() {
          var TargetResource = $injector.get("Emergency");
          var action = TargetResource["::get::alert::emergency"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.emergencies.create() instead.
        "::create::user::emergencies": {
          url: urlBase + "/users/:id/emergencies",
          method: "POST"
        },

        // INTERNAL. Use User.emergencies.createMany() instead.
        "::createMany::user::emergencies": {
          isArray: true,
          url: urlBase + "/users/:id/emergencies",
          method: "POST"
        },
    ...
    */
    R.modelName = "Emergency";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Emergency#user
         * @methodOf lbServices.Emergency
         *
         * @description
         *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::emergency::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Emergency.alerts
     * @header lbServices.Emergency.alerts
     * @object
     * @description
     *
     * The object `Emergency.alerts` groups methods
     * manipulating `Alert` instances related to `Emergency`.
     *
     * Call {@link lbServices.Emergency#alerts Emergency.alerts()}
     * to query all related instances.
     */
        ...
        R.alerts = function() {
          ...
          var action = TargetResource["::get::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#count
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
         * Counts alerts of emergency.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.alerts.count = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::count::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#create
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.create = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::create::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#createMany
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.createMany = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::createMany::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#destroyAll
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.destroyAll = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::delete::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#destroyById
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.destroyById = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::destroyById::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#findById
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.findById = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::findById::emergency::alerts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Emergency.alerts#updateById
         * @methodOf lbServices.Emergency.alerts
         *
         * @description
         *
        ...
        R.alerts.updateById = function() {
          var TargetResource = $injector.get("Alert");
          var action = TargetResource["::updateById::emergency::alerts"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.EmailDomainWhitelist
 * @header lbServices.EmailDomainWhitelist
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `EmailDomainWhitelist` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/EmailDomainWhitelists/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#create
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `EmailDomainWhitelist` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/EmailDomainWhitelists",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#createMany
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#upsert
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#exists
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/EmailDomainWhitelists/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#findById
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/EmailDomainWhitelists/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#find
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#findOne
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/EmailDomainWhitelists/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#updateAll
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/EmailDomainWhitelists/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#deleteById
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#count
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/EmailDomainWhitelists/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#prototype$updateAttributes
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#createChangeStream
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/EmailDomainWhitelists/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#updateOrCreate
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#update
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#destroyById
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EmailDomainWhitelist#removeById
         * @methodOf lbServices.EmailDomainWhitelist
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.EmailDomainWhitelist#modelName
    * @propertyOf lbServices.EmailDomainWhitelist
    * @description
    * The name of the model represented by this $resource,
    * i.e. `EmailDomainWhitelist`.
    */
    R.modelName = "EmailDomainWhitelist";
